...
- **[GCF Proxy](https://github.com/blackwell-systems/gcf-proxy)** - Drop-in MCP proxy that re-encodes JSON tool responses as GCF. 71% fewer tokens, 100% comprehension across 1,700+ LLM evaluations. Zero code changes. `npm install -g @blackwell-systems/gcf-proxy`
